...
export function FinancialOverviewChart({ data = [], isLoading = false }: FinancialOverviewChartProps) {
  ...
  return (
    <div className="flex h-80 flex-col rounded-[var(--radius-xl)] bg-white p-6 shadow-sm dark:bg-surface-900">
      <h3 className="mb-4 text-[length:var(--text-h3)] font-semibold text-surface-900 dark:text-white">Revenue vs Expenses</h3>
      ...
      <div className="flex-1">
        {data.length === 0 ? (
          <EmptyState
            ...
            description="Add trips, fuel logs, or expenses to visualize financial performance."
            compact
