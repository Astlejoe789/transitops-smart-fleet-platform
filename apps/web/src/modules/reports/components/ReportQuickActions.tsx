...
export function ReportQuickActions({ onCreateReport, onExport }: ReportQuickActionsProps) {
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <QuickAction
        icon={Plus}
        title="Create Report"
        description="Generate a new custom report from your fleet data."
      ...
      <QuickAction
        icon={BarChart2}
        title="Saved Reports"
        description="Access and view your previously saved reports."
      ...
      <QuickAction
        ...
        description="Configure report schedules, formats, and recipients."
      ...
      <QuickAction
        icon={Download}
        title="Export All"
        description="Download bulk data exports for external systems."
