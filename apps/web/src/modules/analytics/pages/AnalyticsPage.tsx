...
import { 
  ...
  FileText, Briefcase, ShoppingCart, BarChart3
} from 'lucide-react';
import { 
...
export default function AnalyticsPage() {
  ...
  const hasData = kpis && (kpis.totalTrips > 0 || kpis.totalRevenue > 0 || kpis.activeVehicles > 0);
    ...
    <PageContainer className="p-6 space-y-6">
      ...
      {!hasData ? (
        <EmptyState 
          ...
          description="Reports and analytics will appear here once you start adding vehicles, drivers, and logging trips."
        />
      ) : (
        <>
